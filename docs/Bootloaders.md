...
This document does not cover the method to flash a bootloader to the At90usb1286
...
Like the SAMD21, the SAMD51 bootloader is flashed via the ARM Serial Wire Debug
